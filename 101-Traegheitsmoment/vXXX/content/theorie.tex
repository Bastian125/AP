...
Die Formel (5) ist Teil der Lösung der DGL 2ter Ordnung (von der Bewegungsgleichung eines harmonischen Oszillators) und gilt nur für kleine
...
Das Trägheitsmoment eines Zylinders mit Radius $r$, Höhe $h$ und dessen Drehachse durch den Schwerpunkt und senkrecht zur Bodenfläche steht (stehend),
 lässt sich folgendermaßen mithilfe Formel (2) berechnen:
\begin{align*}
...
Das Trägheitsmoment einer Kugel mit Radius $R$ und Höhe $h$ lässt sich wie folgt mit Formel (2) berechnen:
\begin{align*}
...
Das Trägheitsmoment eines Stabes der Masse $M$ und der Länge $a$ lässt sich wie folgt mit Formel (2) berechnen:
