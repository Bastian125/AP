...
das Gesamtträgheitsmoment ($I_G$ und $I_D$) gemessen werden kann. Es gilt $I_{Ges} = I_D + I_G$. Mithilfe von Formel (1) und (8) ergibt sich Folgendes:
\begin{equation}
    I_{Ges} = I_D + 2 \cdot \left(\frac{m_G R_G^2}{4} + \frac{m_G h_G^2}{12} \right) + 2 \cdot m_G \cdot a^2
\end{equation}

Die Formel (12) wird nun in Formel (6) eingesetzt:
...
\end{equation}
Formel (13) besitzt die Form $y = mx + b$. Wobei 
\begin{align*}
